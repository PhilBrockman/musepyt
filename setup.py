...
setup(
  ...
  author_email = 'phil.brockman@gmail.com.com',      # Type in your E-Mail
  url = 'https://github.com/PhilBrockman/musepyt',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/PhilBrockman/musepyt/archive/v_01.tar.gz',    # I explain this later on
